...
public class LorenzAtrractor extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        x0Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/x0.gif"))); // NOI18N
        x0Label.setText("vx0");

        y0Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/y0.gif"))); // NOI18N
        y0Label.setText("vy0");

        z0Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/z0.gif"))); // NOI18N
        z0Label.setText("vz0");

        sLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/s.gif"))); // NOI18N
        sLabel.setText("vs");

        rLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/r.gif"))); // NOI18N
        rLabel.setText("vr");

        bLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/b.gif"))); // NOI18N
        bLabel.setText("vb");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LorenzAtrractor/LorenzEq.gif"))); // NOI18N
